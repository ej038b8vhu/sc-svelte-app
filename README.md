# Svelte Syntax
  ...
  - [Svelte](https://svelte.dev/)
    - Svelte shifts as much work as possible out of the browser and into your build step. 
...
**Why is HMR( Hot Module Reloading ) not preserving my local component state?**
